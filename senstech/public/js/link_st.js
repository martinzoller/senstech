frappe.ui.form.ControlLink = frappe.ui.form.ControlData.extend({
	...
	setup_awesomeplete: function() {
		...
		this.$input.on("input", function(e) {
			console.log("link.js: Dropdown list loading");
			me.dropdown_loading = true;
			var context = this, args = arguments;
			var inline_debounce = function() {
				me.input_timeout = null;
				console.log("link.js: inline_debounce");
			...
			clearTimeout(me.input_timeout);
			me.input_timeout = setTimeout(inline_debounce, 500);
		});
